...
const NavPane = () => {
    return (
      ...
      <Navbar bg="dark" variant="dark" expand="lg">
        <Container>
          <Navbar.Brand href="#homeHash">Chelsea Carroll</Navbar.Brand>
          <Navbar.Toggle aria-controls="basic-navbar-nav" bg="dark" variant="dark"/>
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="me-auto">
              <Nav.Link href="#homeHash">Home</Nav.Link>
              <Nav.Link href="#BioHash">About Me</Nav.Link>
              <Nav.Link href="#skillsHash">Skills Overview</Nav.Link>
